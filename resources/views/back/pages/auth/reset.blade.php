...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Page Title Hare')
...
@section('content')
    <div class="login-box bg-white box-shadow border-radius-10">
        ...
        <form action="{{ route('admin.reset_password_handler',['token'=>$token]) }}" method="POST">
            ...
            <div class="input-group custom mb-1">
                <input type="password" class="form-control form-control-lg" placeholder="Confirm New Password" name="confirm_password" >
                <div class="input-group-append custom">
                    <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                </div>
            </div>
